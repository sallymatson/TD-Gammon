...
```{r relu basic, echo=FALSE, cache=TRUE}
trained_agent.10000.2 = readRDS(file="saved/2/trained_agent_10000_relu_basic.rds")
trained_agent.50000.2 = readRDS(file="saved/2/trained_agent_50000_relu_basic.rds")
trained_agent.100000.2 = readRDS(file="saved/2/trained_agent_100000_relu_basic.rds")
trained_agent.150000.2 = readRDS(file="saved/2/trained_agent_150000_relu_basic.rds")
trained_agent.200000.2 = readRDS(file="saved/2/trained_agent_200000_relu_basic.rds")
```
